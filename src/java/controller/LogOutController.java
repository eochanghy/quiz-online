...
/**
 * Contains a method that removes attribute "account" and attribute "quiz", then
 * forward to <code>Login.jsp</code>. Servlet will directly forward to
...
public class LogOutController extends HttpServlet {
    ...
    /**
     * Removes attribute "account" and attribute "quiz", then forward to
     * <code>Login.jsp</code>. Servlet will directly forward to
     * <code>Error.jsp</code> when any error occurs.
     *
     * @param request stores attributes: account, quiz. It is a
